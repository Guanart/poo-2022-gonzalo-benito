...
public class GameControler {
    ...
    private Model model;
    private View view;
    private int xJugador1 = 0;
    private int yJugador1 = 0;
    ...
    private void movePlayer() {
        model.setPlayerX(xJugador1);//arbitrary limit which maybe outside bounds
        model.setPlayerY(yJugador1);//arbitrary limit which maybe outside bounds
        view.refresh();
